...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/nllgrid-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14262&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/nllgrid-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `nllgrid` can be installed with:

```
conda install nllgrid
```

It is possible to list all of the versions of `nllgrid` available on your platform with:
